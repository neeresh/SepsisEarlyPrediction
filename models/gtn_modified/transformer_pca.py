...
from models.gtn.encoder import Encoder
import math
...
class Transformer(Module):
    def __init__(self,
        ...
        self.mlp_fc1 = torch.nn.Linear(gate_output_dim, 4096)
        self.mlp_relu = torch.nn.ReLU()
        self.mlp_fc2 = torch.nn.Linear(4096, 4096)
        self.output_linear = torch.nn.Linear(4096, d_output)
    ...
    def forward(self, x, stage):
        ...
        # Adding MLP
        encoding = self.mlp_fc1(encoding)
        encoding = self.mlp_relu(encoding)
        encoding = self.mlp_fc2(encoding)
