...
def prepare_test_data():
    ...
    destination_path = os.path.join(os.getcwd(), 'labels_modified_gtn_0')
    for i, (patient_data, file_name) in enumerate(
...
def evaluate():
    ...
    output_directory = "./predictions_modified_gtn_0/"
    ...
    model_path = "./saved_models/modified_gtn/modified_gtn_2.pkl"
...
auroc, auprc, accuracy, f_measure, normalized_observed_utility = evaluate_sepsis_score(
    label_directory='./labels_modified_gtn_0/', prediction_directory='./predictions_modified_gtn_0/')
