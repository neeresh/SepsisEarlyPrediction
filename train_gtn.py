...
if __name__ == '__main__':
    ...
    train_loader, test_loader = make_loader(training_examples, lengths_list, is_sepsis, 128, mode='window')
    ...
    # config = gtn_param
    # d_input, d_channel, d_output = 336, 40, 2  # (time_steps, channels, num_classes)
    # num_epochs = 1
    #
    # logging.info(config)
